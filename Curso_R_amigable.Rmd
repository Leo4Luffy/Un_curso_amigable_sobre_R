...
En esta parte del curso sobre la __manipulación de datos__ se empleara el conjunto de datos `palmerpenguins`, el cual resultó de una investigación donde se examinó el dimorfismo sexual ecológico entre pingüinos del género _Pygoscelis_.
...
Descargo de responsabilidad: El conjunto de datos `palmerpenguins` hace parte de un paquete del mismo nombre que podrás encontrar [aquí](https://github.com/allisonhorst/palmerpenguins). Las desarrolladoras del paquete mencionan que este conjunto de datos debe entenderse como datos de muestra para aprender sobre herramientas de manipulación y visualización<!--, y cualquier persona interesada en publicarlos deberá comunicarse previamente con las personas responables de su recopilación-->.
...
Estructura general de lo datos: A continuación podrá hechar un vistazo de la estructura del conjunto de datos `palmerpenguins`:
...
```{r,eval=FALSE}
save(Pinguinos, file = "data_pkg/Pinguinos.rda")
```
...
filtrado <- data.frame(
  ...
  annotate(geom = 'text', x = 15.0, y = 11.5, label = '.data = palmerpenguins,', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 14.79, y = 11.25, label = 'especies == "Adelie" &', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 14.4, y = 11.0, label = 'island == "Dream"', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 12.5, y = 10.75, label = ')', size = 7.4, colour = 'black') +
...
+ Elegir filas usando su posición con `slice()`
...
posicion <- data.frame(
  ...
  annotate(geom = 'text', x = 15.0, y = 11.5, label = '.data = palmerpenguins,', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 13.0, y = 11.25, label = '1:4', size = 7.4, colour = 'black') +
...
seleccion <- data.frame(
  ...
  annotate(geom = 'text', x = 15.0, y = 11.5, label = '.data = palmerpenguins,', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 13.5, y = 11.25, label = 'especies,', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 14.1, y = 11.0, label = 'culmen_length,', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 14.0, y = 10.75, label = 'culmen_depth', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 12.5, y = 10.5, label = ')', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 14.8, xmax = 15.2, ymin = 10.1, ymax = 4.3, colour = 'cyan', fill = 'cyan', alpha = 1.0) +
  annotate(geom = 'rect', xmin = 23.3, xmax = 23.7, ymin = 10.1, ymax = 4.3, colour = 'cyan', fill = 'cyan', alpha = 1.0) +
  annotate(geom = 'rect', xmin = 26.05, xmax = 26.45, ymin = 10.1, ymax = 4.3, colour = 'cyan', fill = 'cyan', alpha = 1.0) +
  annotate(geom = 'rect', xmin = 28.3, xmax = 28.7, ymin = 10.1, ymax = 4.3, colour = 'cyan', fill = 'cyan', alpha = 1.0) +
  scale_y_continuous(limits = c(4.0, 11.78)) +
  #scale_x_continuous(limits = c(8, 5.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
