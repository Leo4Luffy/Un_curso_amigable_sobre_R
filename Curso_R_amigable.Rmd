...
seleccion <- data.frame(
  ...
  annotate(geom = 'rect', xmin = 14.8, xmax = 15.2, ymin = 10.1, ymax = 4.3, colour = 'red', fill = 'red', alpha = 1.0) +
  annotate(geom = 'rect', xmin = 23.3, xmax = 23.7, ymin = 10.1, ymax = 4.3, colour = 'red', fill = 'red', alpha = 1.0) +
  annotate(geom = 'rect', xmin = 26.05, xmax = 26.45, ymin = 10.1, ymax = 4.3, colour = 'red', fill = 'red', alpha = 1.0) +
  annotate(geom = 'rect', xmin = 28.3, xmax = 28.7, ymin = 10.1, ymax = 4.3, colour = 'red', fill = 'red', alpha = 1.0) +
