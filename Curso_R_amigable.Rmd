...
```{r,eval=FALSE}
save(Starwars, file="data_pkg/mtcars_1.rda")
save(Starwars, file="data_pkg/mtcars_2.rda")
save(Starwars, file="data_pkg/mtcars_3.rda")
```
