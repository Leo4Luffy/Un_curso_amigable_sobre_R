...
#### 2.3.4 Lectura de conjuntos de datos

Frecuentemente, los conjuntos de datos a ser leidos en el programa `R` se almacenan en dos formatos: archivo de texto plano con extensión __.txt__ o archivo de Excel o similar con extensión __.csv__.
...
<div class="row">
  ...
  Dentro de las ventajas de los tibbles en comparación con los conjuntos de datos creados a partir del sistema base cabe mencionar:
  </div>
  <div class="col-md-5" markdown="1">
