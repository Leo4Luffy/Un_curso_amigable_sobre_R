...
__Descargo de responsabilidad:__ El conjunto de datos `palmerpenguins` hace parte de un paquete del mismo nombre que podrás encontrar [aquí](https://github.com/allisonhorst/palmerpenguins). Las desarrolladoras del paquete mencionan que este conjunto de datos debe entenderse como datos de muestra para aprender sobre herramientas de manipulación y visualización, y cualquiera persona interesada en publicarlos deberá comunicarse previamente con las personas responables de su recopilación.

__Cita de datos:__ Gorman KB, Williams TD, Fraser WR (2014) Dimorfismo sexual ecológico y variabilidad ambiental dentro de una comunidad de Pingüinos antárticos (Género _Pygoscelis_). PLoS ONE 9 (3): e90081. https://doi.org/10.1371/journal.pone.0090081

__Estructura general de lo datos:__ El conjunto de datos `palmerpenguins` ya se encuentra en formato ordenado. A continuación podrá hechar un vistazo de su estructura:
...
+ En `species`podrá encontrar las tres especies existentes del genéro de pingüinos _Pygoscelis_.

+ En `island` podrá encontrar el nombre de las islas donde fueron ubicadas las colonias de pingüinos.

<div class="row">
  <div class="col-md-6" markdown="1">
+ En `culmen_length_mm` se registró la longitud del culmen (margen superior del pico) de las tres especies de pingüinos.
+ En `culmen_depth_mm` se registró la profundidad del culmen de las tres especies de pingüinos.
  </div>
  <div class="col-md-6" markdown="1">
```{r, echo = FALSE, eval = TRUE, out.width = "38%", fig.align = "center"}
...
+ En `flipper_length_mm` se registró la longitud de la aleta de las tres especies de pingüinos.

+ En `body_mass_g` se registró la masa corporal de cada uno de los pingüinos.

+ En `sex` podrá encontrar la información sobre el sexo (FEMALE para hembras y MALE para machos) de cada uno de los pingüinos.
...
filtrado <- data.frame(
  ...
  annotate(geom = 'text', x = 15.0, y = 11.5, label = '.data = palmerpenguins,', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 14.74, y = 11.25, label = 'especies == "Adelie",', size = 7.4, colour = 'black') +
...
mutacion <- data.frame(
  ...
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 9.5, ymax = 10.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 9.75, label = 'sex', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 9.0, ymax = 9.5, colour = 'red', fill = 'red', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 9.25, label = 'Male', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 8.5, ymax = 9.0, colour = 'red', fill = 'red', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 8.75, label = 'Male', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 8.0, ymax = 8.5, colour = 'red', fill = 'red', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 8.25, label = 'NA', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 7.5, ymax = 8.0, colour = 'red', fill = 'red', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 7.75, label = 'Female', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 7.0, ymax = 7.5, colour = 'red', fill = 'red', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 7.25, label = 'Female', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 6.5, ymax = 7.0, colour = 'red', fill = 'red', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 6.75, label = 'Male', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 6.0, ymax = 6.5, colour = 'red', fill = 'red', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 6.25, label = 'Female', family = 'gochi', size = 7.4, colour = 'black') +
  ...
  annotate(geom = 'text', x = 15.5, y = 10.75, label = 'sex == "MALE" ~ "Male"', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 13.2, y = 10.35, label = ')', size = 7.4, colour = 'black') +
