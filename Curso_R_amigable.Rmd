...
Es la variabilidad existente entre los elementos del grupo experimental sometidos al mismo tratamiento.

$$EE = \frac{(r_{A} - 1)S_{A}^{2} + (r_{B} - 1)S_{B}^{2} + (r_{C} - 1)S_{C}^{2}}{r_{A} + r_{B} + r_{C} - 3}$$
