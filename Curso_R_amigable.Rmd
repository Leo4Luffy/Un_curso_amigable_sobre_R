...
En `R` se cuenta con las conocidas funciones base, muchas con utilidades estadísticas o en cualquier proyecto de análisis. A continuación podrá ver algunas de ellas: 
...
:::caution
Una __función__ en `R` es un procedimiento que generalmente toma un objeto como argumentos (también conocido como entrada), hace algo con ese objeto y luego devuelve un nuevo objeto (la salida).
:::
