...
La función `arrange()` permite ordenar un conjunto de datos en función del valor de una determinada variable. Esto puede ser útil si se desea ver rápidamente qué mediciones tuvieron los valores más altos o más bajos.
...
organizar <- data.frame(
  ...
  annotate(geom = 'text', x = 14.3, y = 11.25, label = 'desc(body_mass)', size = 7.4, colour = 'black') +
