...
data.frame(
  ...
  annotate(geom = 'text', x = 3.875, y = 3.5, label = '52', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 3.5, xmax = 4.25, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.875, y = 2.5, label = '49', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 3.5, xmax = 4.25, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.875, y = 1.5, label = '45', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 3.5, xmax = 4.25, ymin = 0.0, ymax = 1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.875, y = 0.5, label = '55', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 3.5, xmax = 4.25, ymin = -1.0, ymax = 0.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.875, y = -0.5, label = '48', family = 'gochi', size = 11.0, colour = 'black') +
  ...
  annotate(geom = 'text', x = 4.625, y = 3.5, label = '43', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.25, xmax = 5.0, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 4.625, y = 2.5, label = '49', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.25, xmax = 5.0, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 4.625, y = 1.5, label = '50', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.25, xmax = 5.0, ymin = 0.0, ymax = 1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 4.625, y = 0.5, label = '40', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.25, xmax = 5.0, ymin = -1.0, ymax = 0.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 4.625, y = -0.5, label = '65', family = 'gochi', size = 11.0, colour = 'black') +
