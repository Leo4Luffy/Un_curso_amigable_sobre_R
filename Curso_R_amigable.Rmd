...
+ __Multiplataforma__: El intérprete de `R` está disponible en muchas plataformas (Linux, Windows, UNIX, Mac OS, etc), por lo que podrá correr en muchos computadores.
...
```
<section style="text-align: center;">Encuentro en el [Rday 2019](https://rdaymedellin.github.io/).</section>
  </div>
</div>
...
Es hora de instalar uno de los programas estadísticos más utilizados por las distintas universidades y empresas.
...
#Suma sobre los dos primeros elementos del vector de prueba
test_2 <- x + c(10,20)
test_2
...
De igual forma podemos utilizar la resta, te invito a que restablezcas el vector de prueba a partir de los vectores test_1, test_2, test_3. Para ello copia los vectores que realizamos en el fragmento de código anterior y logra crear de nuevo el vector x. Dale confio en que podrás hacerlo.
