...
#### `r fa("fas fa-chalkboard-teacher", fill = "black")` Ejemplo 2.3
...
#### `r fa("fas fa-laptop-code", fill = "black")` Ejercicio 2.4

```{r exe_4, exercise = TRUE}
#Vector de prueba
vec <- seq(1,150,3)
vec
...
#### `r fa("fas fa-laptop-code", fill = "black")` Ejercicio 2.5

```{r exe_5, exercise = TRUE}
#Vector de prueba
vec <- seq(1,100,length.out = 20)
vec
