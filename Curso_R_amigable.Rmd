...
La indexación numérica permite acceder a los valores de un vector de acuerdo a su posición especifica dentro del vector. Para esto, se emplea la forma __a[index]__, donde __a__ es el vector e __index__ es es el índice del vector.
...
```{r, echo = FALSE, eval = TRUE, out.width = "24%", fig.align = "center"}

knitr::include_graphics("images/44va_imagen.png")  
```

+ Cambio de valores de un vector
