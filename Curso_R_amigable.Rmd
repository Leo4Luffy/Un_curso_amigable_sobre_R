...
Starwars_human[order(Starwars_human$height),]
#Ordenar por altura descendentemente
Starwars_human[order(Starwars_human$height,decreasing = T),]
#Hombres de Tatooine
