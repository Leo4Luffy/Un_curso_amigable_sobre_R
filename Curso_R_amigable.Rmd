...
+-------------+-------------------------------------------------------------------+
| `nrow()`    | Calcula el número de filas en un objete de dos dimensiones        |
+-------------+-------------------------------------------------------------------+
| `ncol()`    | Calcula el número de columnas en un objete de dos dimensiones     |
+-------------+-------------------------------------------------------------------+
...
Del fragmento de código anterior sabemos que la gran mayoría de personajes de Starwars son humanos, ahora veamos cómo seleccionar un subconjunto de los datos en el cual solo estén los personajes humanos, conservando las demás características presentes en la base de datos.
