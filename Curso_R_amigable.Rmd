...
La capa 5 de estadística (`stat_`), permite presentar resumenes estadísticos dentro de los gráficos por medio de una transformación estadística de los datos.
...
<div class="row">
  <div class="col-md-6" markdown="1">
```{r ejemplo_6_2_1_4_1_1, exercise = TRUE, fig.align = "center", out.width='380'}
...
pokemon <- pokemon %>%
  ...
  group_by(tipo) %>%
  summarise(
    Prom_fuerza_total = mean(fuerza_total)
    )
    
ggplot(
  data = pokemon,
  aes(x = tipo, y = Prom_fuerza_total, colour = tipo, fill = tipo)
  ) +
  geom_bar(stat = 'identity')
```
  </div>
  <div class="col-md-6" markdown="1">
```{r ejemplo_6_2_1_4_1_2, exercise = TRUE, fig.align = "center", out.width='380'}
