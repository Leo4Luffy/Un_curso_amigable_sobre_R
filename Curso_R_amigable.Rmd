...
mutacion <- data.frame(
  ...
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 9.5, ymax = 10.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 9.75, label = 'sex', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 9.0, ymax = 9.5, colour = 'green', fill = 'green', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 9.25, label = 'Male', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 8.5, ymax = 9.0, colour = 'green', fill = 'green', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 8.75, label = 'Male', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 8.0, ymax = 8.5, colour = 'green', fill = 'green', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 8.25, label = 'NA', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 7.5, ymax = 8.0, colour = 'green', fill = 'green', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 7.75, label = 'Female', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 7.0, ymax = 7.5, colour = 'green', fill = 'green', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 7.25, label = 'Female', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 6.5, ymax = 7.0, colour = 'green', fill = 'green', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 6.75, label = 'Male', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 6.0, ymax = 6.5, colour = 'green', fill = 'green', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 6.25, label = 'Female', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 5.5, ymax = 6.0, colour = 'green', fill = 'green', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 5.75, label = 'Male', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 5.0, ymax = 5.5, colour = 'green', fill = 'green', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 5.25, label = 'Female', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 27.5, xmax = 29.5, ymin = 4.5, ymax = 5.0, colour = 'green', fill = 'green', alpha = 0.2) +
  annotate(geom = 'text', x = 28.5, y = 4.75, label = 'Male', family = 'gochi', size = 7.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 12.2, xmax = 13.5, ymin = 11.72, ymax = 11.78, colour = 'green', fill = 'green', alpha = 0.2) +
  annotate(geom = 'text', x = 13.0, y = 11.75, label = 'mutate (', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 14.9, y = 11.5, label = '.data = palmerpenguins,', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 14.4, y = 11.25, label = 'sex = case_when(', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 16.0, y = 11.0, label = 'sex == "FEMALE" ~ "Female",', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 15.48, y = 10.75, label = 'sex == "MALE" ~ "Male"', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 12.8, y = 10.35, label = ')', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 12.4, y = 10.25, label = ')', size = 7.4, colour = 'black') +
  scale_y_continuous(limits = c(4.0, 11.78)) +
  #scale_x_continuous(limits = c(8, 5.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
