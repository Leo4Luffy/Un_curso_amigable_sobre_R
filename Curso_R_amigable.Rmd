...
+-------------+-------------------------------+
| `colSums(M)`| Suma de colunnas de la Matriz |
+-------------+-------------------------------+
| `rowSums(M)`| Suma de filas de la Matriz    |
+-------------+-------------------------------+
...
Trabajemos ahora con algunas operaciones sobre filas y columnas, como nombrarlas modificarlas y utilizarlas.
...
#Matriz de prueba 1
m <- matrix(seq(15,-10,length.out = 24),ncol = 6,byrow = T)
m
...
Dato_ordenado_1 <- data.frame(
  ...
  annotate(geom = 'text', x = 3.25, y = 5.25, label = 'Vec1', family = 'gochi', size = 6.4, colour = 'black') +
  ...
  annotate(geom = 'text', x = 4.25, y = 6.5, label = 'data.frame', family = 'gochi', size = 9.4, colour = 'black') +
...
Dato_ordenado_2 <- data.frame(
  ...
  annotate(geom = 'segment', x = 5.5, xend = 5.5, y = 5.5, yend = 6.0, colour = 'black') +
  annotate(geom = 'segment', x = 3.25, xend = 5.5, y = 6.0, yend = 6.0, colour = 'black') +
  annotate(geom = 'text', x = 4.25, y = 6.5, label = 'Conjunto de datos 1', family = 'gochi', size = 9.4, colour = 'black') +
  scale_y_continuous(limits = c(1, 7.0)) +
  scale_x_continuous(limits = c(2.85, 6.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
...
<!--
En este punto, puede pensar que los datos ordenados son tan obvios que son triviales. Seguramente, la mayoría de los conjuntos de datos vienen en un formato ordenado, ¿verdad? Incorrecto. En la práctica, los datos sin procesar rara vez son ordenados y, como resultado, es mucho más difícil trabajar con ellos. La Sección 2.4 proporciona un ejemplo realista de los datos recopilados en la naturaleza.
-->
...
largo_2 <- data.frame(
  ...
  annotate(geom = 'text', x = 17.0, y = 7.75, label = 'Población', family = 'gochi', size = 6.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 16.0, xmax = 18.0, ymin = 7.0, ymax = 7.5, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'text', x = 17.0, y = 7.25, label = '19987071', family = 'gochi', size = 6.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 16.0, xmax = 18.0, ymin = 6.5, ymax = 7.0, colour = 'red', fill = 'red', alpha = 0.2) +
  annotate(geom = 'text', x = 17.0, y = 6.75, label = '20595360', family = 'gochi', size = 6.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 16.0, xmax = 18.0, ymin = 6.0, ymax = 6.5, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'text', x = 17.0, y = 6.25, label = '172006362', family = 'gochi', size = 6.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 16.0, xmax = 18.0, ymin = 5.5, ymax = 6.0, colour = 'red', fill = 'red', alpha = 0.2) +
  annotate(geom = 'text', x = 17.0, y = 5.75, label = '174504896', family = 'gochi', size = 6.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 16.0, xmax = 18.0, ymin = 5.0, ymax = 5.5, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'text', x = 17.0, y = 5.25, label = '1272915272', family = 'gochi', size = 6.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 16.0, xmax = 18.0, ymin = 4.5, ymax = 5.0, colour = 'red', fill = 'red', alpha = 0.2) +
  annotate(geom = 'text', x = 17.0, y = 4.75, label = '1280428583', family = 'gochi', size = 6.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 21.0, xmax = 23.0, ymin = 7.5, ymax = 8.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 22.0, y = 7.75, label = 'País', family = 'gochi', size = 6.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 21.0, xmax = 23.0, ymin = 7.0, ymax = 7.5, colour = 'black', fill = 'white', alpha = 0.4) +
  annotate(geom = 'text', x = 22.0, y = 7.25, label = 'Afganistán', family = 'gochi', size = 6.4, colour = 'black') +
  ...
  annotate(geom = 'text', x = 24.0, y = 7.75, label = '1999', family = 'gochi', size = 6.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 23.0, xmax = 25.0, ymin = 7.0, ymax = 7.5, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'text', x = 24.0, y = 7.25, label = '19987071', family = 'gochi', size = 6.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 23.0, xmax = 25.0, ymin = 6.5, ymax = 7.0, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'text', x = 24.0, y = 6.75, label = '172006362', family = 'gochi', size = 6.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 23.0, xmax = 25.0, ymin = 6.0, ymax = 6.5, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'text', x = 24.0, y = 6.25, label = '1272915272', family = 'gochi', size = 6.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 25.0, xmax = 27.0, ymin = 7.5, ymax = 8.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 26.0, y = 7.75, label = '2000', family = 'gochi', size = 6.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 25.0, xmax = 27.0, ymin = 7.0, ymax = 7.5, colour = 'red', fill = 'red', alpha = 0.2) +
  annotate(geom = 'text', x = 26.0, y = 7.25, label = '20595360', family = 'gochi', size = 6.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 25.0, xmax = 27.0, ymin = 6.5, ymax = 7.0, colour = 'red', fill = 'red', alpha = 0.2) +
  annotate(geom = 'text', x = 26.0, y = 6.75, label = '174504896', family = 'gochi', size = 6.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 25.0, xmax = 27.0, ymin = 6.0, ymax = 6.5, colour = 'red', fill = 'red', alpha = 0.2) +
  annotate(geom = 'text', x = 26.0, y = 6.25, label = '1280428583', family = 'gochi', size = 6.4, colour = 'black') +
  geom_curve(x = 23.0, xend = 18.0, y = 7.25, yend = 7.25, arrow = arrow(length = unit(0.1, 'inch')), size = 0.5, color = 'black', curvature = +0.4) +
  geom_curve(x = 23.0, xend = 18.0, y = 6.75, yend = 6.25, arrow = arrow(length = unit(0.1, 'inch')), size = 0.5, color = 'black', curvature = +0.4) +
  geom_curve(x = 23.0, xend = 18.0, y = 6.25, yend = 5.25, arrow = arrow(length = unit(0.1, 'inch')), size = 0.5, color = 'black', curvature = +0.4) +
  geom_curve(x = 25.0, xend = 18.0, y = 7.25, yend = 6.75, arrow = arrow(length = unit(0.1, 'inch')), size = 0.5, color = 'black', curvature = +0.4) +
