...
Del fragmento de código anterior sabemos que la gran mayoría de personajes de Starwars son humanos, ahora veamos cómo seleccionar un subconjunto de los datos en el cual solo estén los personajes humanos, conservando también las otras características presentes en la base de datos. Además de ello con `Starwars_human` podemos probar la función `sort()` utilizando la masa de los individuos y visualizar los hombres provenientes de Tatooine.
...
organizar <- data.frame(
  ...
  geom_curve(x = 19.6, xend = 19.6, y = 4.5, yend = 9.4, arrow = arrow(length = unit(0.1, 'inch')), size = 1.4, colour = 'black', curvature = 0.0) +
