...
data.frame(
  ...
  annotate(geom = 'text', x = 1.75, y = 4.5, label = 'ls()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 3.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 3.5, label = 'rm(a, b, ...)', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 2.5, label = 'getwd()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 1.5, label = 'setwd()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 0.0, ymax = 1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 0.5, label = 'list.files()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = -1.0, ymax = 0.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = -0.5, label = 'rm(list = ls())', family = 'gochi', size = 5.0, colour = 'black') +
  ...
  annotate(geom = 'text', x = 3.75, y = 4.7, label = 'Muestra todos los objetos en', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 3.75, y = 4.3, label = 'el espacio de trabajo actual.', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 5.0, ymin = 3.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.75, y = 3.7, label = 'Elimina los objetos (a, b...)', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 3.75, y = 3.3, label = 'del espacio de trabajo.', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 5.0, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.75, y = 2.5, label = 'Devuelve el directorio de trabajo actual.', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 5.0, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.75, y = 1.7, label = 'Cambia el directorio de trabajo', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 3.75, y = 1.3, label = 'a una ubicación especifica.', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 5.0, ymin = 0.0, ymax = 1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.75, y = 0.7, label = 'Devuelve los nombres de los archivos', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 3.75, y = 0.3, label = 'en el directorio de trabajo.', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 5.0, ymin = -1.0, ymax = 0.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.75, y = -0.3, label = 'Elimina todos los objetos del', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 3.75, y = -0.7, label = 'espacio de trabajo.', family = 'gochi', size = 4.4, colour = 'black') +
