...
Indexar matrices y conjuntos de datos mediante el uso de vectores lógicos es muy similar a lo visto con vectores:
  ...
  2- Se indexa un conjunto de datos usando el vector lógico, el cual solo devuelve aquellos valores para los que el vector lógico es `TRUE`.
...
+ Indexación mediante el uso de los operadores `[[]]` y `$`
