...
:::caution
colocar aqui un mensaje de lo que sucede al crear una matriz con clases atomicas diferentes y colocar luego un ejemplo para motrarlo.
:::
...
#### 2.4 Conjuntos de datos en paquetes de `R`
