...
```{r ejemplo_gapminder, echo= FALSE ,eval=FALSE , fig.align = "center", out.width='580'}
...
gapminder %>%
  ...
  ggplot(
    data = .,
    aes(x = gdpPercap, y = lifeExp, size = pop, colour = Continente, fill = Continente)
    ) +
  geom_point(alpha = 0.4) +
  ...
  labs(title = 'Año: {frame_time}', x = 'PIB per cápita', y = 'Expectativa de vida al nacer') +
  theme_bw() +
  theme(
  ...
  enter_fade() +
  exit_fade()
anim_save('images/ejemplo_animacion.gif')
```
...
```{r datos_gapminder, echo = FALSE, eval = FALSE, message = FALSE}
...
```{r paquete_gganimate_1, exercise = TRUE, fig.align = "center"}
...
```{r paquete_gganimate_2, exercise = TRUE, fig.align = "center"}
...
Las funciones `transition_*` definen como los datos se dividen en subconjuntos de datos, que variables cambian en la animación y cómo cambian (transición).

:::example
#### Ejemplo 6.4.1.1.1
:::

```{r ejemplo_6_4_1_1_1, exercise = TRUE}
...
#### 6.4.1.2 Indicar los datos anteriores: `shadow_*`

:::example
#### Ejemplo 6.4.1.2.1
:::

```{r ejemplo_6_4_1_2_1, exercise = TRUE}
...
#### 6.4.1.3 Etiquetado dinámico: `{ }`

:::example
#### Ejemplo 6.4.1.3.1
:::

```{r ejemplo_6_4_1_3_1, exercise = TRUE}
