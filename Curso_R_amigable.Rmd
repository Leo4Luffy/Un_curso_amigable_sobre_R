...
amigos$fisico[[5]][3][[1]] / (amigos$fisico[[5]][2][[1]] / 100)^2 # IMC de Karol
amigos$fisico[[6]][3][[1]] / (amigos$fisico[[6]][2][[1]] / 100)^2 # IMC de Javier
```
...
Si se desea extraer los elementos almacenados en un arreglo, se usa el operador `[ ]` a igual que en una matriz.
