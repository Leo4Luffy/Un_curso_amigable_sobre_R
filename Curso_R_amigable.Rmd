...
data.frame(
  ...
  ggplot(aes(x, y)) +
  geom_blank() +
  annotate(geom = 'rect', xmin = 1.0, xmax = 1.45, ymin = 1.55, ymax = 3.0, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.45, ymin = 2.55, ymax = 3.0, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 1.5, xmax = 1.95, ymin = 1.55, ymax = 3.0, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.45, ymin = 2.05, ymax = 2.5, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 2.0, xmax = 2.45, ymin = 1.55, ymax = 3.0, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.45, ymin = 1.55, ymax = 2.0, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'text', x = 1.225, y = 2.775, label = 'A1', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 1.225, y = 2.275, label = 'A2', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 1.225, y = 1.775, label = 'A3', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 1.725, y = 2.775, label = 'B1', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 1.725, y = 2.275, label = 'B2', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 1.725, y = 1.775, label = 'B3', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 2.225, y = 2.775, label = 'C1', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 2.225, y = 2.275, label = 'C2', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 2.225, y = 1.775, label = 'C3', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 1.225, y = 3.125, label = 'A', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 1.725, y = 3.125, label = 'B', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 2.225, y = 3.125, label = 'C', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 0.875, y = 2.775, label = '1', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 0.875, y = 2.275, label = '2', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 0.875, y = 1.775, label = '3', family = 'gochi', size = 24.0, colour = 'black') +
  #scale_y_continuous(limits = c(2.05, 5.0)) +
  #scale_x_continuous(limits = c(1.0, 7.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
