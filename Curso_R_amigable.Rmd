...
ciencia_datos <- data.frame(
  ...
  annotate(geom = 'text', x = 3.45, y = 2.45, label = 'Manipular', family = 'gochi', size = 10.4, colour = 'black') +
...
El `tidyverse` es una colección de paquetes `R` que tienen como objetivo cubrir todo el espectro de análisis de datos dentro de `R`<!--, cada uno de los cuales apoya al otro en conceptos y resultados-->. Los paquetes dentro del `tidyverse` son:
...
```
  ...
  <div class="col-md-4" markdown="1">
  `ggplot2` para crear __gráficos__ declarativamente, basado en la gramática de gráficos.
  </div>
  <div class="col-md-2" markdown="1">
