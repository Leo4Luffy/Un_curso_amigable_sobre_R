...
Un vector consiste en una colección de escalares de la misma clase atómica. Es decir que un vector puede contener n elementos de la misma clase, ya sean estos números, caracteres o lógicos, pero nunca podrán ser de dos o más clases diferentes.
...
Las matrices son útiles para almacenar muchos datos y son bastante similares a las hojas de cálculo de Excel. Se puede pensar en una matriz como un conjunto de n vectores de la misma longitud.
...
data.frame(
  ...
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 2.6, label = 'matrix(x, nrow, ncol,', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 1.75, y = 2.4, label = 'byrow)', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  ...
  annotate(geom = 'rect', xmin = 5.0, xmax = 6.5, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.75, y = 2.6, label = 'matrix(x = 1:12, nrow = 3,', family = 'gochi', size = 3.7, colour = 'black') +
  annotate(geom = 'text', x = 5.75, y = 2.4, label = ' ncol = 4)', family = 'gochi', size = 3.7, colour = 'black') +
  annotate(geom = 'rect', xmin = 5.0, xmax = 6.5, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.75, y = 1.6, label = 'data.frame("age" = c(19,', family = 'gochi', size = 3.7, colour = 'black') +
  annotate(geom = 'text', x = 5.75, y = 1.4, label = '21), sex = c("m", "f"))', family = 'gochi', size = 3.7, colour = 'black') +
  #scale_y_continuous(limits = c(2.05, 5.0)) +
  #scale_x_continuous(limits = c(1.0, 7.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
...
<p align="center">
  <img src="images/rmarkdown_1.gif" width=1050"/>
</p>
...
<p align="center">
  <img src="images/rmarkdown_2.gif" />
</p>
