...
tidyverse_update() # Si deseas actualizar el tidyverse.
```

Es importante mencionar que el `tidyverse` está en constante evolución. Las mejores formas de mantenerse al día con él son:
...
table2 %>%
  rename('País' = country, 'Año' = year, 'Casos/Población' = key, 'Valor' = value) %>%
  kable() %>% 
  kable_styling(full_width = FALSE,
                bootstrap_options = (c('striped', 'bordered')))
```
