...
```{r ejemplo_6_2_1_4, exercise = TRUE, fig.align = "center", out.width='380'}
...
```{r ejemplo_6_2_5, exercise = TRUE, fig.align = "center", out.width='380'}
...
data.frame(
  ...
  annotate(geom = 'text', x = 6.0, y = 4.5, label = 'theme_classic()', family = 'gochi', size = 4.4, colour = 'black') +
