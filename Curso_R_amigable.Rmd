...
data.frame(
  ...
  annotate(geom = 'text', x = 5.25, y = 3.2, label = '192.45', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 5.695, y = 2.715, label = '0.245', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 6.1, y = 2.25, label = '6.223', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 5.0, y = 2.95, label = '263.21', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 5.445, y = 2.465, label = '0.444', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 5.85, y = 2.0, label = '8.224', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 4.75, y = 2.70, label = '532.34', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 5.195, y = 2.215, label = '0.348', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 5.60, y = 1.75, label = '1.229', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 4.50, y = 2.45, label = '643.09', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 4.945, y = 1.965, label = 'NA', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 5.35, y = 1.50, label = '0.983', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 4.25, y = 2.20, label = '325.11', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 4.695, y = 1.715, label = '0.356', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 5.10, y = 1.25, label = '3.205', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 4.0, y = 1.95, label = '867.42', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 4.445, y = 1.465, label = 'NA', size = 8.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 4.85, y = 1.0, label = '3.017', size = 8.0, colour = 'black', angle = -7) +
  geom_polygon(data = Diamante_2, aes(x = x, y = y), fill = 'cyan', colour = 'cyan', alpha = 0.2) +
  annotate(geom = 'text', x = 4.9, y = 5.4, label = 'A', size = 16.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 5.75, y = 4.45, label = 'X', size = 16.0, colour = 'black', angle = -7) +
  geom_curve(x = 5.0, xend = 5.65, y = 5.4, yend = 4.45, arrow = arrow(length = unit(0.1, 'inch')), size = 1.0, color = 'black', curvature = 0.0) +
  annotate(geom = 'text', x = 4.1, y = 4.6, label = 'B', size = 16.0, colour = 'black', angle = -7) +
  annotate(geom = 'text', x = 4.95, y = 3.65, label = 'Y', size = 16.0, colour = 'black', angle = -7) +
  ...
  geom_polygon(data = Diamante_6, aes(x = x, y = y), fill = 'orange', colour = 'orange', alpha = 0.2) +
  geom_curve(x = 3.8, xend = 5.0, y = 14.45, yend = 13.30, arrow = arrow(length = unit(0.1, 'inch')), size = 1.2, color = 'black', curvature = 0.0) +
  geom_curve(x = 3.8, xend = 5.0, y = 14.45, yend = 15.30, arrow = arrow(length = unit(0.1, 'inch')), size = 1.2, color = 'black', curvature = 0.0) +
  geom_polygon(data = Diamante_7, aes(x = x, y = y), fill = 'black', colour = 'black', alpha = 0.2) +
  #geom_polygon(data = rombo_10, aes(x = x, y = y), fill = 'red', colour = 'red', alpha = 1.2) +
  #geom_polygon(data = rombo_11, aes(x = x, y = y), fill = 'yellow', colour = 'yellow', alpha = 1.2) +
  #geom_polygon(data = rombo_12, aes(x = x, y = y), fill = 'green', colour = 'green', alpha = 1.2) +
  #geom_polygon(data = rombo_13, aes(x = x, y = y), fill = 'cyan', colour = 'cyan', alpha = 1.2) +
  ...
  annotate(geom = 'text', x = 6.56, y = 6.0, label = 'Geometrías', angle = 10, family = 'gochi', size = 12.0, colour = 'black') +
  annotate(geom = 'text', x = 6.6, y = 8.6, label = 'Facetas', angle = 10, family = 'gochi', size = 12.0, colour = 'black') +
  annotate(geom = 'text', x = 6.54, y = 10.9, label = 'Estadísticas', angle = 10, family = 'gochi', size = 12.0, colour = 'black') +
...
```{r, echo = FALSE, eval = FALSE, message = FALSE, fig.align = 'center', fig.showtext = TRUE, out.width = '440'}
...
data.frame(
  ...
  ggplot(aes(x, y)) +
  geom_blank() +
  annotate(geom = 'rect', xmin = 1.0, xmax = 1.45, ymin = 2.55, ymax = 3.0, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 1.0, xmax = 1.45, ymin = 2.05, ymax = 2.5, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 1.0, xmax = 1.45, ymin = 1.55, ymax = 2.0, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 1.5, xmax = 1.95, ymin = 2.55, ymax = 3.0, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 1.5, xmax = 1.95, ymin = 2.05, ymax = 2.5, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 1.5, xmax = 1.95, ymin = 1.55, ymax = 2.0, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 2.0, xmax = 2.45, ymin = 2.55, ymax = 3.0, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 2.0, xmax = 2.45, ymin = 2.05, ymax = 2.5, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 2.0, xmax = 2.45, ymin = 1.55, ymax = 2.0, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'text', x = 1.225, y = 2.775, label = '1', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 1.225, y = 2.275, label = '4', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 1.225, y = 1.775, label = '7', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 1.725, y = 2.775, label = '2', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 1.725, y = 2.275, label = '5', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 1.725, y = 1.775, label = '8', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 2.225, y = 2.775, label = '3', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 2.225, y = 2.275, label = '6', family = 'gochi', size = 24.0, colour = 'black') +
  annotate(geom = 'text', x = 2.225, y = 1.775, label = '9', family = 'gochi', size = 24.0, colour = 'black') +
  #scale_y_continuous(limits = c(2.05, 5.0)) +
  #scale_x_continuous(limits = c(1.0, 7.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
...
data.frame(
  ...
  annotate(geom = 'rect', xmin = 2.0, xmax = 2.45, ymin = 2.05, ymax = 2.5, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 2.0, xmax = 2.45, ymin = 1.55, ymax = 2.0, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'text', x = 1.225, y = 2.775, label = 'A1', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'text', x = 1.225, y = 2.275, label = 'A2', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'text', x = 1.225, y = 1.775, label = 'A3', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'text', x = 1.725, y = 2.775, label = 'B1', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'text', x = 1.725, y = 2.275, label = 'B2', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'text', x = 1.725, y = 1.775, label = 'B3', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'text', x = 2.225, y = 2.775, label = 'C1', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'text', x = 2.225, y = 2.275, label = 'C2', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'text', x = 2.225, y = 1.775, label = 'C3', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'text', x = 1.225, y = 3.135, label = 'A', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'text', x = 1.725, y = 3.135, label = 'B', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'text', x = 2.225, y = 3.135, label = 'C', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'text', x = 0.940, y = 2.775, label = '1', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'text', x = 0.940, y = 2.275, label = '2', family = 'gochi', size = 11.0, colour = 'black') +
  annotate(geom = 'text', x = 0.940, y = 1.775, label = '3', family = 'gochi', size = 11.0, colour = 'black') +
  #scale_y_continuous(limits = c(2.05, 5.0)) +
  #scale_x_continuous(limits = c(1.0, 7.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
...
data.frame(
  ...
  ggplot(aes(x, y)) +
  geom_blank() +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 1.0, ymax = 2.5, colour = 'black', fill = 'white') +
  annotate(geom = 'segment', x = 0.995, xend = 2.5, y = 2.25, yend = 2.25, colour = 'black', size = 1.0) +
  annotate(geom = 'segment', x = 0.995, xend = 2.5, y = 2.0, yend = 2.0, colour = 'black', size = 1.0) +
  annotate(geom = 'segment', x = 0.995, xend = 2.5, y = 1.75, yend = 1.75, colour = 'black', size = 1.0) +
  annotate(geom = 'segment', x = 0.995, xend = 2.5, y = 1.5, yend = 1.5, colour = 'black', size = 1.0) +
  annotate(geom = 'segment', x = 0.995, xend = 2.5, y = 1.25, yend = 1.25, colour = 'black', size = 1.0) +
  annotate(geom = 'text', x = 0.96, y = 2.25, label = '5', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 0.96, y = 2.0, label = '4', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 0.96, y = 1.75, label = '3', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 0.96, y = 1.5, label = '2', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 0.96, y = 1.25, label = '1', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'segment', x = 1.25, xend = 1.25, y = 0.96, yend = 2.5, colour = 'black', size = 1.0) +
  annotate(geom = 'segment', x = 1.5, xend = 1.5, y = 0.96, yend = 2.5, colour = 'black', size = 1.0) +
  annotate(geom = 'segment', x = 1.75, xend = 1.75, y = 0.96, yend = 2.5, colour = 'black', size = 1.0) +
  annotate(geom = 'segment', x = 2.0, xend = 2.0, y = 0.96, yend = 2.5, colour = 'black', size = 1.0) +
  annotate(geom = 'segment', x = 2.25, xend = 2.25, y = 0.96, yend = 2.5, colour = 'black', size = 1.0) +
  annotate(geom = 'text', x = 1.25, y = 0.9, label = '2.5', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 1.5, y = 0.9, label = '5.0', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 1.75, y = 0.9, label = '7.5', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 2.0, y = 0.9, label = '10.0', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 2.25, y = 0.9, label = '12.5', family = 'gochi', size = 8.0, colour = 'black') +
  #scale_y_continuous(limits = c(2.05, 5.0)) +
  #scale_x_continuous(limits = c(1.0, 7.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
...
ggplot() +
  annotate(geom = 'rect', xmin = 1.4, xmax = 1.6, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white') +
  geom_point(aes(x = 1.5, y = 1.5), size = 43, pch = 1) +
  geom_point(aes(x = 1.5, y = 1.5), size = 83, pch = 1) +
  geom_point(aes(x = 1.5, y = 1.5), size = 123, pch = 1) +
  annotate(geom = 'segment', x = 1.5, xend = 1.435, y = 1.5, yend = 1.53, colour = 'black', size = 1.0) +
  annotate(geom = 'segment', x = 1.5, xend = 1.462, y = 1.5, yend = 1.9, colour = 'black', size = 1.0) +
  annotate(geom = 'segment', x = 1.5, xend = 1.462, y = 1.5, yend = 1.1, colour = 'black', size = 1.0) +
  annotate(geom = 'segment', x = 1.5, xend = 1.535, y = 1.5, yend = 1.1, colour = 'black', size = 1.0) +
  annotate(geom = 'segment', x = 1.5, xend = 1.565, y = 1.5, yend = 1.48, colour = 'black', size = 1.0) +
  annotate(geom = 'segment', x = 1.5, xend = 1.548, y = 1.5, yend = 1.78, colour = 'black', size = 1.0) +
  annotate(geom = 'text', x = 1.395, y = 1.9, label = '5', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 1.395, y = 1.8, label = '4', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 1.395, y = 1.7, label = '3', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 1.395, y = 1.6, label = '2', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 1.395, y = 1.5, label = '1', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 1.556, y = 1.785, label = '2.5', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 1.54, y = 1.1, label = '5.0', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 1.455, y = 1.1, label = '7.5', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 1.427, y = 1.53, label = '10.0', family = 'gochi', size = 8.0, colour = 'black') +
  annotate(geom = 'text', x = 1.456, y = 1.9, label = '12.5', family = 'gochi', size = 8.0, colour = 'black') +
  #scale_y_continuous(limits = c(2.05, 5.0)) +
  #scale_x_continuous(limits = c(1.0, 7.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
...
tema_grey <- readJPEG('images/theme_grey.jpg', native = TRUE)
tema_grey <- rasterGrob(tema_grey, interpolate = FALSE)

tema_bw <- readJPEG('images/theme_bw.jpg', native = TRUE)
tema_bw <- rasterGrob(tema_bw, interpolate = FALSE)

tema_linea <- readJPEG('images/theme_linedraw.jpg', native = TRUE)
tema_linea <- rasterGrob(tema_linea, interpolate = FALSE)

tema_claro <- readJPEG('images/theme_light.jpg', native = TRUE)
tema_claro <- rasterGrob(tema_claro, interpolate = FALSE)

tema_oscuro <- readJPEG('images/theme_dark.jpg', native = TRUE)
tema_oscuro <- rasterGrob(tema_oscuro, interpolate = FALSE)

tema_minimo <- readJPEG('images/theme_minimal.jpg', native = TRUE)
tema_minimo <- rasterGrob(tema_minimo, interpolate = FALSE)

tema_clasico <- readJPEG('images/theme_classic.jpg', native = TRUE)
tema_clasico <- rasterGrob(tema_clasico, interpolate = FALSE)

tema_poquito <- readJPEG('images/theme_void.jpg', native = TRUE)
tema_poquito <- rasterGrob(tema_poquito, interpolate = FALSE)
...
data.frame(
  ...
  ggplot(aes(x, y)) +
  geom_blank() +
  annotate(geom = 'rect', xmin = 1.0, xmax = 3.0, ymin = 7.0, ymax = 8.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 2.0, y = 7.5, label = 'theme_grey()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 3.0, ymin = 5.0, ymax = 7.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotation_custom(tema_grey, xmin = 1.01, xmax = 2.99, ymin = 5.01, ymax = 6.99) +
  annotate(geom = 'rect', xmin = 3.0, xmax = 5.0, ymin = 7.0, ymax = 8.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 4.0, y = 7.5, label = 'theme_bw()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 3.0, xmax = 5.0, ymin = 5.0, ymax = 7.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotation_custom(tema_bw, xmin = 3.01, xmax = 4.99, ymin = 5.01, ymax = 6.99) +
  annotate(geom = 'rect', xmin = 5.0, xmax = 7.0, ymin = 7.0, ymax = 8.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 6.0, y = 7.5, label = 'theme_linedraw()', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 5.0, xmax = 7.0, ymin = 5.0, ymax = 7.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotation_custom(tema_linea, xmin = 5.01, xmax = 6.99, ymin = 5.01, ymax = 6.99) +
  annotate(geom = 'rect', xmin = 7.0, xmax = 9.0, ymin = 7.0, ymax = 8.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 8.0, y = 7.5, label = 'theme_light()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 7.0, xmax = 9.0, ymin = 5.0, ymax = 7.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotation_custom(tema_claro, xmin = 7.01, xmax = 8.99, ymin = 5.01, ymax = 6.99) +
  annotate(geom = 'rect', xmin = 1.0, xmax = 3.0, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 2.0, y = 4.5, label = 'theme_dark()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 3.0, ymin = 2.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotation_custom(tema_oscuro, xmin = 1.01, xmax = 2.99, ymin = 2.01, ymax = 3.99) +
  annotate(geom = 'rect', xmin = 3.0, xmax = 5.0, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 4.0, y = 4.5, label = 'theme_minimal()', family = 'gochi', size = 4.7, colour = 'black') +
  annotate(geom = 'rect', xmin = 3.0, xmax = 5.0, ymin = 2.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotation_custom(tema_minimo, xmin = 3.01, xmax = 4.99, ymin = 2.01, ymax = 3.99) +
  annotate(geom = 'rect', xmin = 5.0, xmax = 7.0, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 6.0, y = 4.5, label = 'theme_classic()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 5.0, xmax = 7.0, ymin = 2.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotation_custom(tema_clasico, xmin = 5.01, xmax = 6.99, ymin = 2.01, ymax = 3.99) +
  annotate(geom = 'rect', xmin = 7.0, xmax = 9.0, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 8.0, y = 4.5, label = 'theme_void()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 7.0, xmax = 9.0, ymin = 2.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotation_custom(tema_poquito, xmin = 7.01, xmax = 8.99, ymin = 2.01, ymax = 3.99) +
  #scale_y_continuous(limits = c(2.05, 5.0)) +
  #scale_x_continuous(limits = c(1.0, 7.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
...
data.frame(
  ...
  annotate(geom = 'text', x = 1.75, y = 5.5, label = 'Componente', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 4.5, label = 'plot.background', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 3.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 3.5, label = 'plot.title', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 2.5, label = 'plot.margin', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 5.0, ymax = 6.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 5.5, label = 'Función', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 4.5, label = 'element_rect()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 3.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 3.5, label = 'element_text()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 2.5, label = 'margin()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 5.0, ymax = 6.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 5.5, label = 'Descripción', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 4.5, label = 'Fondo del gráfico.', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 3.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 3.5, label = 'Título del gráfico.', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 2.5, label = 'Márgen alrededor del gráfico.', family = 'gochi', size = 4.5, colour = 'black') +
  #scale_y_continuous(limits = c(2.05, 5.0)) +
  #scale_x_continuous(limits = c(1.0, 7.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
...
data.frame(
  ...
  annotate(geom = 'text', x = 1.75, y = 5.5, label = 'Componente', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 4.5, label = 'axis.line', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 3.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 3.5, label = 'axis.text', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 2.5, label = 'axis.text.x', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 1.5, label = 'axis.text.y', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 0.0, ymax = 1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 0.5, label = 'axis.title', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = -1.0, ymax = 0.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = -0.5, label = 'axis.title.x', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = -2.0, ymax = -1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = -1.5, label = 'axis.title.y', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = -3.0, ymax = -2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = -2.5, label = 'axis.ticks', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 5.0, ymax = 6.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 5.5, label = 'Función', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 4.5, label = 'element_line()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 3.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 3.5, label = 'element_text()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 2.5, label = 'element_text()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 1.5, label = 'element_text()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 0.0, ymax = 1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 0.5, label = 'element_text()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = -1.0, ymax = 0.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = -0.5, label = 'element_text()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = -2.0, ymax = -1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = -1.5, label = 'element_text()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = -3.0, ymax = -2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = -2.5, label = 'element_line()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 5.0, ymax = 6.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 5.5, label = 'Descripción', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 4.5, label = 'Línea paralela al eje.', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 3.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 3.5, label = 'Etiquetas de marca.', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 2.5, label = 'Etiquetas de marca del eje x.', family = 'gochi', size = 4.6, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 1.5, label = 'Etiquetas de marca del eje y.', family = 'gochi', size = 4.6, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 0.0, ymax = 1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 0.5, label = 'Títulos de los ejes.', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = -1.0, ymax = 0.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = -0.5, label = 'Título del eje x.', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = -2.0, ymax = -1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = -1.5, label = 'Título del eje y.', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = -3.0, ymax = -2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = -2.5, label = 'Marcas de los ejes.', family = 'gochi', size = 5.0, colour = 'black') +
  #scale_y_continuous(limits = c(2.05, 5.0)) +
  #scale_x_continuous(limits = c(1.0, 7.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
...
data.frame(
  ...
  annotate(geom = 'text', x = 1.75, y = 5.5, label = 'Componente', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 4.5, label = 'legend.background', family = 'gochi', size = 4.7, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 3.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 3.5, label = 'legend.key', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 2.5, label = 'legend.key.size', family = 'gochi', size = 4.7, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 1.5, label = 'legend.key.height', family = 'gochi', size = 4.7, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 0.0, ymax = 1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 0.5, label = 'legend.key.width', family = 'gochi', size = 4.7, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = -1.0, ymax = 0.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = -0.5, label = 'legend.margin', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = -2.0, ymax = -1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = -1.5, label = 'legend.text', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = -3.0, ymax = -2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = -2.5, label = 'legend.title', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = -4.0, ymax = -3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = -3.5, label = 'legend.position', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 5.0, ymax = 6.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 5.5, label = 'Función', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 4.5, label = 'element_rect()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 3.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 3.5, label = 'element_rect()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 2.5, label = 'unit()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 1.5, label = 'unit()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 0.0, ymax = 1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 0.5, label = 'unit()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = -1.0, ymax = 0.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = -0.5, label = 'unit()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = -2.0, ymax = -1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = -1.5, label = 'element_text()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = -3.0, ymax = -2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = -2.5, label = 'element_text()', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = -4.0, ymax = -3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 5.0, ymax = 6.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 5.5, label = 'Descripción', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 4.5, label = 'Fondo de la leyenda.', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 3.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 3.5, label = 'Fondo de la clave de la leyenda.', family = 'gochi', size = 4.2, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 2.5, label = 'Tamaño de la clave de la leyenda.', family = 'gochi', size = 4.2, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 1.5, label = 'Altura de la clave de la leyenda.', family = 'gochi', size = 4.2, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 0.0, ymax = 1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 0.5, label = 'Ancho de la clave de la leyenda.', family = 'gochi', size = 4.2, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = -1.0, ymax = 0.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = -0.5, label = 'Margen de la leyenda.', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = -2.0, ymax = -1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = -1.5, label = 'Etiquetas de la leyenda.', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = -3.0, ymax = -2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = -2.5, label = 'Nombre de la leyenda.', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = -4.0, ymax = -3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = -3.5, label = 'Posición de la leyenda.', family = 'gochi', size = 5.0, colour = 'black') +
  #scale_y_continuous(limits = c(2.05, 5.0)) +
  #scale_x_continuous(limits = c(1.0, 7.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
...
data.frame(
  ...
  annotate(geom = 'text', x = 1.75, y = 5.5, label = 'Componente', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 4.5, label = 'strip.background', family = 'gochi', size = 4.7, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 3.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 3.5, label = 'strip.text', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 2.5, label = 'strip.text.x', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 1.5, label = 'strip.text.y', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = 0.0, ymax = 1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = 0.5, label = 'panel.margin', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = -1.0, ymax = 0.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = -0.5, label = 'panel.margin.x', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = -2.0, ymax = -1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = -1.5, label = 'panel.margin.y', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 5.0, ymax = 6.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 5.5, label = 'Función', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 4.0, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.25, y = 4.5, label = 'element_rect()', family = 'gochi', size = 5.0, colour = 'black') +
  ...
  annotate(geom = 'text', x = 5.0, y = 5.5, label = 'Descripción', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 4.5, label = 'Fondo de cada franja de panel.', family = 'gochi', size = 4.6, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 3.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 3.5, label = 'Texto de la franja del panel.', family = 'gochi', size = 4.8, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 2.5, label = 'Texto de la franja horizontal.', family = 'gochi', size = 4.6, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 1.5, label = 'Texto de la franja vertical.', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = 0.0, ymax = 1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = 0.5, label = 'Margen entre facetas.', family = 'gochi', size = 5.0, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = -1.0, ymax = 0.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = -0.5, label = 'Margen entre facetas (vertical).', family = 'gochi', size = 4.6, colour = 'black') +
  annotate(geom = 'rect', xmin = 4.0, xmax = 6.0, ymin = -2.0, ymax = -1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 5.0, y = -1.5, label = 'Margen entre facetas (horizontal).', family = 'gochi', size = 4.4, colour = 'black') +
  #scale_y_continuous(limits = c(2.05, 5.0)) +
  #scale_x_continuous(limits = c(1.0, 7.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
...
:::caution
Si deseas ver un resumen de las posibilidades que ofrece el paquete `ggplot2` y profundizar más en su uso, puedes mirar su hoja de trucos [aquí](https://github.com/Leo4Luffy/Un_curso_amigable_sobre_R/blob/master/Documentos/cheat_sheet_ggplot2.pdf).
:::
...
Afortunadamente, hacer este tipo de visualizaciones se ha vuelto hoy en día bastante simple mediante el uso de paquetes de `R`. Para explicar como hacer estas visualizaciones se empleará los conjuntos de datos que observan a continuación:

```{r, eval = FALSE, message = FALSE, echo = FALSE}

load(file = 'data_pkg/england.rda')
...
# Mediante un bucle for, se desea que en cada temporada se muestre la suma de todos los puntos ganados o acumulados hasta esa temporada. ----
Tabla <- Pts_temporada %>%
  filter(Season == 1888) %>%
  select(Season, Equipo, Puntos = Pts)

for(i in 1889:2017){
  Tabla <- Pts_temporada %>%
    filter(Season <= i) %>%
    group_by(Equipo) %>%
    summarise(Puntos = sum(Pts, na.rm = TRUE)) %>%
    mutate(Season = i) %>%
    bind_rows(Tabla)
  }

# Se incluyen algunos hechos historicos. ----
Pts_temporada_acumulada <- Tabla %>%
  mutate(
    Hecho_hist = case_when(
      Season <= 1891 ~ paste(Season, 'La Football League se forma con 12 equipos en 1888.', sep = '-'),
      between(Season, 1892, 1895) ~ paste(Season, 'Se introduce la segunda división en el año de 1892.', sep = '-'),
      between(Season, 1914, 1918) ~ paste(Season, 'Se suspende el torneo durante la primera guerra mundial.', sep = '-'),
      between(Season, 1920, 1924) ~ paste(Season, 'Se introduce la tercera división entre los años de 1920 a 1921.', sep = '-'),
      between(Season, 1925, 1928) ~ paste(Season, 'Se introduce la nueva ley de fuera de juego en el años de 1925.', sep = '-'),
      between(Season, 1939, 1945) ~ paste(Season, 'Se suspende el torneo durante la segunda guerra mundial.', sep = '-'),
      between(Season, 1958, 1961) ~ paste(Season, 'Se introduce la cuarta división en el año de 1958.', sep = '-'),
      between(Season, 1965, 1968) ~ paste(Season, 'Se permiten los sustitutos por primera vez.', sep = '-'),
      between(Season, 1974, 1977) ~ paste(Season, 'Se juego por primera vez en el año de 1974 un partido el día domingo.', sep = '-'),
      between(Season, 1981, 1984) ~ paste(Season, 'Se introduce tres puntos por una victoria en el año de 1981.', sep = '-'),
      between(Season, 1986, 1989) ~ paste(Season, 'Se introduce los Play-offs para decidir promociones.', sep = '-'),
      between(Season, 1992, 1995) ~ paste(Season, 'Se forma la Premier League en el año de 1992, reduciendo la Football League a tres divisiones más inferiores.', sep = '-'),
      between(Season, 2004, 2007) ~ paste(Season, 'La Football League cambia el nombre de las divisiones a Championsip, League One y League Two.', sep = '-'),
      between(Season, 2013, 2016) ~ paste(Season, 'Se introduce la Goal Line Technology en la Premier League en el año 2013.', sep = '-'),
      1L == 1L ~ as.character(Season)
      )
    )

# Se guarda algunas de las bases de datos anteriores. ----
save(Pts_temporada, file = "data_pkg/Ptos_premier_league.rda", compress='xz') # Base de datos que contiene los puntos obtenidos por cada equipo en cada una de las temporadas.
save(Pts_temporada_acumulada, file = "data_pkg/Hist_premier_league.rda", compress='xz') # Base de datos que contiene los puntos acumulados por cada uno de los equipos entre las temporadas de 1888 a 2017, con una columna adicional de algunos hechos historicos. Se oberva mayor número de observaciones porque algunos equipos (como por ejemplo el Accrington F.C.) aun cuando no siguieron en la Premier League en años posteriores, en esos años se consideraron el último puntaje acumulado.
```

```{r, eval = TRUE, message = FALSE, echo = FALSE}

load(file = 'data_pkg/Ptos_premier_league.rda')
```
...
load(file = 'data_pkg/Hist_premier_league.rda')
```

```{r datos_premier_2, exercise = TRUE}

Pts_temporada_acumulada
```
...
El paquete `gganimate` extiende la gramática de gráficos implementada en el paquete `ggplot2` para permitir una visualización animada de los gráficos.

Esto lo hace al proporcionar una nueva gama de funciones que se pueden agregar al código de graficación de la misma manera que agrega un `geom_` u otra capa gráfica, lo cual, permite personalizar como la misma debe cambiar. Estos son:
  </div>
  <div class="col-md-6" markdown="1">
```{r, echo = FALSE, eval = TRUE, out.width = "70%", fig.align = "center"}
...
```{r ejemplo_6_4_2_1, exercise = TRUE, fig.align = "center", out.width='580'}
...
Pts_temporada %>%
  ...
  ggplot(
    data = .,
    aes(x = Season, y = Pts, colour = Equipo, fill = Equipo)
    ) +
  geom_line() +
