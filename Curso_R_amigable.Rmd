...
data.frame(
  ...
  annotate(geom = 'text', x = 3.25, y = 3.0, label = 'Tranformar', family = 'gochi', size = 10.4, colour = 'black') +
...
Estudiante de ingeniería ambiental interesado en la ecología, la programación y la ciencia de datos. contacame en el correo  <a href="mailto:dnieves@unal.edu.co"><u>correo</u></a>.
