...
Dentro de los múltiples objetos en `R`, sean estos simples como un vector o compuestos como un conjunto de datos, se debe tener claro como manejar o acceder a la información contenida en los mismos. Para estos casos se utiliza la __indexación__.

+ Indexación numérica

:::caution
Colocar antesitos aqui lo del indice [1]
:::
