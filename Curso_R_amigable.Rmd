...
Variables <- data.frame(
  ...
  annotate(geom = 'text', x = 4.0, y = 3.5, label = 'Variables', family = 'gochi', size = 20.4, colour = 'black') +
...
Observaciones <- data.frame(
  ...
  annotate(geom = 'text', x = 4.0, y = 3.5, label = 'Observaciones', family = 'gochi', size = 16.4, colour = 'black') +
  scale_y_continuous(limits = c(1, 3.6)) +
  scale_x_continuous(limits = c(3, 5.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
...
Valores_2 <- data.frame(
  ...
  annotate(geom = 'rect', xmin = 4.5, xmax = 5.0, ymin = 2.0, ymax = 2.5, colour = 'black', fill = 'black', alpha = 0.4) +
  annotate(geom = 'rect', xmin = 4.5, xmax = 5.0, ymin = 2.5, ymax = 3.0, colour = 'black', fill = 'black', alpha = 0.4) +
  annotate(geom = 'text', x = 4.0, y = 3.5, label = 'Valores', family = 'gochi', size = 20.4, colour = 'black') +
