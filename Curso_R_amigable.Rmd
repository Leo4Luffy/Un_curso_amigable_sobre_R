...
Podemos notar que al utilizar la función `data.frame` el vector de letras es convertido a factor, lo que en algunos casos puede no ser conveniente, para evitar estos inconvenientes podemos utilizar el argumento `stringsAsFactors = F`.
