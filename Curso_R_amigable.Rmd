...
`group_by()`<!--http://www.rebeccabarter.com/blog/2019-08-05_base_r_to_tidyverse/-->
...
#### 5.2.1.9 Operaciones en varias columnas con `across()`
...
resumen <- data.frame(
  ...
  annotate(geom = 'text', x = 17.5, y = 3.25, label = '', family = 'gochi', size = 6.0, colour = 'black') +
  ...
  annotate(geom = 'text', x = 20.5, y = 3.25, label = '', family = 'gochi', size = 6.0, colour = 'black') +
  ...
  annotate(geom = 'text', x = 33.5, y = 3.25, label = '', family = 'gochi', size = 6.0, colour = 'black') +
  #annotate(geom = 'rect', xmin = 12.2, xmax = 13.5, ymin = 11.72, ymax = 11.78, colour = 'red', fill = 'red', alpha = 0.2) +
...
tuberia <- data.frame(
  ...
  annotate(geom = 'text', x = 16.8, y = 11.25, label = 'filter (gender = "FEMALE") %>%', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 18.35, y = 11.0, label = 'mutate (body_mass_kg = body_mass / 1000)', size = 7.4, colour = 'black') +
  geom_point(aes(x = 28.5, y = 9.75), pch = 'x', size = 20.0, colour = 'red', fill = 'red') +
  annotate(geom = 'text', x = 28.5, y = 10.25, label = 'gender', family = 'gochi', size = 7.4, colour = 'red') +
