...
Pese a que las matrices en el `R` suelen ser usadas para almacenar información, muchas de las operaciones vistas anteriormente con vectores (suma, diferencia, productor y división por ejemplo) también pueden usadas sobre matrices. Adicionalmente, el lenguaje de programación `R` proporciona operadores o funciones adicionales útiles para trabajar con matrices:
...
data.frame(
  ...
  annotate(geom = 'text', x = 1.75, y = -0.4, label = 'colSums(x),', family = 'gochi', size = 4.5, colour = 'black') +
  annotate(geom = 'text', x = 1.75, y = -0.6, label = 'rowSums(x)', family = 'gochi', size = 4.5, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.0, xmax = 2.5, ymin = -2.0, ymax = -1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 1.75, y = -1.4, label = 'colMeans(x),', family = 'gochi', size = 4.5, colour = 'black') +
  annotate(geom = 'text', x = 1.75, y = -1.6, label = 'rowMeans(x)', family = 'gochi', size = 4.5, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 5.0, ymin = 5.0, ymax = 6.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 3.75, y = 5.5, label = 'Descripción', family = 'gochi', size = 5.5, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 5.0, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.75, y = 4.6, label = 'Permite obtener la', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 3.75, y = 4.4, label = 'transpuesta de una matriz.', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 5.0, ymin = 3.0, ymax = 4.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.75, y = 3.6, label = 'Permite calcular el', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 3.75, y = 3.4, label = 'determinante de una matriz.', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 5.0, ymin = 2.0, ymax = 3.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.75, y = 2.6, label = 'Permite calcular la', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 3.75, y = 2.4, label = 'inversa de una matriz.', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 5.0, ymin = 1.0, ymax = 2.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.75, y = 1.6, label = 'Permite obtener los', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 3.75, y = 1.4, label = 'valores de la diagonal.', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 5.0, ymin = 0.0, ymax = 1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.75, y = 0.6, label = 'Permite obtener la', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 3.75, y = 0.4, label = 'traza de una matriz.', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 5.0, ymin = -1.0, ymax = 0.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.75, y = -0.4, label = 'Permite obtener la suma por', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 3.75, y = -0.6, label = 'columnas y filas de una matriz.', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 2.5, xmax = 5.0, ymin = -2.0, ymax = -1.0, colour = 'black', fill = 'white', alpha = 0.2) +
  annotate(geom = 'text', x = 3.75, y = -1.4, label = 'Permite obtener el promedio por', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 3.75, y = -1.6, label = 'columnas y filas de una matriz.', family = 'gochi', size = 4.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 5.0, xmax = 6.5, ymin = 5.0, ymax = 6.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 5.75, y = 5.5, label = 'Ejemplo', family = 'gochi', size = 5.5, colour = 'black') +
  annotate(geom = 'rect', xmin = 5.0, xmax = 6.5, ymin = 4.0, ymax = 5.0, colour = 'black', fill = 'white', alpha = 0.2) +
