...
Las funciones `transition_*()` definen como los datos se dividen en subconjuntos de datos, que variables cambian en la animación y cómo cambian (transición). Algunos tipos de transición son `transition_states()` y `transition_time()`.

:::example
#### Ejemplo 6.4.1.1.1
:::

```{r ejemplo_6_4_1_1_1, exercise = TRUE, fig.align = "center"}
...
El paquete `gganimate` permite también finalizar y guardar las animaciones como un GIF.
