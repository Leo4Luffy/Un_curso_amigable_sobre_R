...
Si se tiene una gran cantidad de columnas o variables con una estructura similar en el nombre, se puede utilizar la concordancia parcial mediante la adición de `starts_with()`, `ends_with()` o `contains()` en la sentencia de selección.
...
Otro uso interesante de la función `select()` consiste en cambiar el nombre de las columnas.
