...
Al igual que con los vectores, tanto en matrices como en conjunto de datos el lenguaje de progamación `R` permite usar el operador `[ ]` para acceder a valores específicos dentro de los mismos, y al igual que con los vectores, la indexación de matrices y conjuntos de datos pueden ser de dos tipos:

+ Indexación numérica

En matrices y conjuntos de datos, el operador `[ ]` toma dos argumentos: el primer argumento el cual se aplica a las filas y el segundo a las columnas.
...
:::caution
Al usar una coma (`,`) dentro del operado `[ ]` se esta dando la instrucción al `R` de buscar los índices solicitados en más de una dimensión. Así, el número antes de la coma será buscado en la primera dimensión del objeto, y el segundo número en su segunda dimensión.
:::
...
nivel_academico <- c('Preescolar', 'Primaria', 'Bachillerato', 'Pregrado universitario', 'Posgrado universitario')
nivel_academico[2, 4]
```

:::caution
Colocar aquí sobre los mensajes de advertencia y de error.
:::

#### 2.3. Crear y convertir conjuntos de datos en `tibbles`
