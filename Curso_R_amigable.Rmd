...
Este diseño se llama completamente al azar porque todos los tratamientos se asignan de manera aleatoria a los grupos experimentales. <!--Esto con el fin de que los posibles efectos ambientales o temporales que pueden influir, sean repartidos equitativamente entre los tratamientos.--> La razón de esta aleatoriedad radica en el hecho de que las variables no controladas pueden ser distribuidas de manera similar, por lo que se no se afecta la respuesta de algún grupo experimental en particular.
...
Se usa un diseño completamente al azar:

+ Cuando el experimento se realiza bajo condiciones ambientales controladas (por ejemplo, ensayos de laboratorio).

+ Cuando se realizan experimentos en los que, a pesar de que las condiciones ambientales no estan controladas, no hay fuentes de variabilidad reconocibles adicionales a los tratamientos.
