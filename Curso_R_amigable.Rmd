...
<details><summary>Animación similar a la de Hans Rosling</summary>

```{r, echo = FALSE, eval = TRUE, out.width = "50%", fig.align = "center"}
knitr::include_graphics("images/ejemplo_animacion.gif")
```
...
<!--Para explicar como hacer estas visualizaciones se empleará el conjunto de datos que se observa a continuación:-->
...
```{r ejemplo_6_4_1_1, exercise = TRUE}
...
#### 6.4.1.2 Indicando datos anteriores: `shadow_*`

:::example
#### Ejemplo 6.4.1.2
:::

```{r ejemplo_6_4_1_2, exercise = TRUE}
...
#anim_save('images/2da_animacion.gif')
```
```{r, echo = FALSE, eval = TRUE, out.width = "50%", fig.align = "center"}
