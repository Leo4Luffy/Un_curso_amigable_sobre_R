...
```{r, eval = FALSE, echo = FALSE, fig.align = 'center', message = FALSE, fig.showtext = TRUE, out.width = '520',fig.height=20,fig.width=30}
...
ciencia_datos <- data.frame(
  ...
  ggplot(aes(x, y)) +
  geom_blank() +
  annotate(geom = 'text', x = 1.7, y = 4.4, label = 'Importar', family = 'gochi', size = 7, colour = 'black') +
  ...
  geom_curve(x = 1.7, xend = 1.7, y = 4.2, yend = 2.6, arrow = arrow(length = unit(0.1, 'inch')), size = 1.0, color = 'black', curvature = 0.0) +
   annotate(geom = 'text', x = 1.7, y = 2.45, label = 'Ordenar', family = 'gochi', size = 7, colour = 'black') +
  geom_curve(x = 2.1, xend = 2.8, y = 2.45, yend = 2.45, arrow = arrow(length = unit(0.1, 'inch')), size = 1.0, color = 'black', curvature = 0.0) +
  annotate(geom = 'text', x = 3.36, y = 2.45, label = 'Manipular', family = 'gochi', size = 7, colour = 'black') +
  annotate(geom = 'text', x = 4.38, y = 3.5, label = 'Visualizar', family = 'gochi', size = 7, colour = 'black') +
  annotate(geom = 'text', x = 4.8, y = 1.5, label = 'Modelar', family = 'gochi', size = 7, colour = 'black') +
  annotation_custom(visualizacion, xmin = 4.2, xmax = 5.6, ymin = -1.1, ymax = 1.7) +
  annotate(geom = 'text', x = 3.8, y = -0.6, label = 'Comunicar', family = 'gochi', size = 7, colour = 'black') +
...
data.frame(
  ...
  annotate(geom = 'text', x = 2.6, y = 4.72, label = 'Nombre de la carpeta del proyecto', family = 'gochi', size = 8, colour = 'black') +
  ...
  annotate(geom = 'text', x = 2.28, y = 4.15, label = 'Archivo .Rproj', family = 'gochi', size = 8, colour = 'black') +
  ...
  annotate(geom = 'text', x = 2.21, y = 3.65, label = 'Datos', family = 'gochi', size = 8, colour = 'black') +
  ...
  annotate(geom = 'text', x = 2.25, y = 3.15, label = 'Código', family = 'gochi', size = 8, colour = 'black') +
  ...
  annotate(geom = 'text', x = 2.63, y = 2.74, label = 'Funciones', family = 'gochi', size = 8, colour = 'black') +
  ...
  annotate(geom = 'text', x = 2.64, y = 2.34, label = 'Análisis A', family = 'gochi', size = 8, colour = 'black') +
  ...
  annotate(geom = 'text', x = 2.64, y = 1.94, label = 'Análisis B', family = 'gochi', size = 8, colour = 'black') +
  annotation_custom(carpeta, xmin = 1.65, xmax = 2.15, ymin = 1.2, ymax = 1.7) +
  annotate(geom = 'text', x = 2.35, y = 1.5, label = 'Resultados', family = 'gochi', size = 8, colour = 'black') +
  ...
  annotate(geom = 'text', x = 2.56, y = 1.0, label = 'Gráficos', family = 'gochi', size = 8, colour = 'black') +
  annotate(geom = 'text', x = 2.55, y = 0.6, label = 'Datos', family = 'gochi', size = 8, colour = 'black') +
...
data.frame(
  x = c(1.0:3.0), y = c(1.0:3.0)
) %>%
  ggplot(aes(x, y)) +
  geom_blank() +
  annotate(geom = 'text', x = 1.8, y = 2.2, label = 'f', family = 'gochi', size = 8.4, colour = 'gray') +
  annotate(geom = 'text', x = 1.85, y = 2.2, label = '<-', family = 'gochi', size = 8.4, colour = 'black') +
  annotate(geom = 'text', x = 1.98, y = 2.2, label = 'function', family = 'gochi', size = 8.4, colour = 'cyan') +
  annotate(geom = 'text', x = 2.35, y = 2.2, label = '( <                            > ) {', family = 'gochi', size = 8.4, colour = 'black') +
  annotate(geom = 'text', x = 2.327, y = 2.2, label = 'ARGUMENTOS', family = 'gochi', size = 8.4, colour = 'yellow') +
  geom_curve(x = 2.64, xend = 2.33, y = 1.86, yend = 2.16, arrow = arrow(length = unit(0.1, 'inch')), size = 0.8, color = 'black', curvature = -0.4) +
  annotate(geom = 'text', x = 2.64, y = 2.0, label = 'Argumentos', family = 'gochi', size = 7.0, colour = 'black') +
  annotate(geom = 'text', x = 2.64, y = 1.9, label = 'formales', family = 'gochi', size = 7.0, colour = 'black') +
  geom_curve(x = 1.96, xend = 1.8, y = 2.415, yend = 2.28, arrow = arrow(length = unit(0.1, 'inch')), size = 0.8, color = 'black', curvature = +0.4) +
  annotate(geom = 'text', x = 2.18, y = 2.42, label = 'Símbolo asociado', family = 'gochi', size = 7.0, colour = 'black') +
  annotate(geom = 'text', x = 2.19, y = 2.32, label = 'con la función', family = 'gochi', size = 7.0, colour = 'black') +
  annotate(geom = 'text', x = 2.0, y = 2.0, label = '# Comentarios', family = 'gochi', size = 8.4, colour = 'yellow') +
  annotate(geom = 'text', x = 2.02, y = 1.8, label = '< Expresiones >', family = 'gochi', size = 8.4, colour = 'yellow') +
  annotate(geom = 'text', x = 1.85, y = 1.6, label = '}', family = 'gochi', size = 8.4, colour = 'black') +
  annotate(geom = 'segment', x = 2.23, xend = 2.23, y = 2.0, yend = 1.8, colour = 'black', size = 1.2) +
  geom_curve(x = 2.7, xend = 2.24, y = 1.66, yend = 1.9, arrow = arrow(length = unit(0.1, 'inch')), size = 0.8, color = 'black', curvature = -0.4) +
  annotate(geom = 'text', x = 2.7, y = 1.7, label = 'Cuerpo de la función', family = 'gochi', size = 7.0, colour = 'black') +
  annotate(geom = 'segment', x = 2.92, xend = 2.92, y = 2.2, yend = 1.6, colour = 'black', size = 1.2) +
  annotate(geom = 'text', x = 2.96, y = 2.1, label = 'A', family = 'gochi', size = 7.0, colour = 'black') +
  annotate(geom = 'text', x = 2.96, y = 2.05, label = 't', family = 'gochi', size = 7.0, colour = 'black') +
  annotate(geom = 'text', x = 2.96, y = 2.0, label = 'r', family = 'gochi', size = 7.0, colour = 'black') +
  annotate(geom = 'text', x = 2.96, y = 1.95, label = 'i', family = 'gochi', size = 7.0, colour = 'black') +
  annotate(geom = 'text', x = 2.96, y = 1.9, label = 'b', family = 'gochi', size = 7.0, colour = 'black') +
  annotate(geom = 'text', x = 2.96, y = 1.85, label = 'u', family = 'gochi', size = 7.0, colour = 'black') +
  annotate(geom = 'text', x = 2.96, y = 1.8, label = 't', family = 'gochi', size = 7.0, colour = 'black') +
  annotate(geom = 'text', x = 2.96, y = 1.75, label = 'o', family = 'gochi', size = 7.0, colour = 'black') +
  annotate(geom = 'text', x = 2.96, y = 1.7, label = 's', family = 'gochi', size = 7.0, colour = 'black') +
  #scale_x_continuous(limits = c(1.8, 6.5)) +
  #scale_y_continuous(limits = c(0.5, 4.2)) +
  theme_void() +
  theme(axis.text = element_blank(),
...
```{r, echo = FALSE, eval = FALSE, message = FALSE, fig.align = 'center', fig.showtext = TRUE, out.width = '460'}
...
Variables <- data.frame(
  ...
  annotate(geom = 'text', x = 4.0, y = 3.25, label = 'Variables', family = 'gochi', size = 8, colour = 'black') +
...
Observaciones <- data.frame(
  ...
  annotate(geom = 'text', x = 4.0, y = 3.25, label = 'Observaciones', family = 'gochi', size = 8, colour = 'black') +
  scale_y_continuous(limits = c(1, 3.3)) +
  scale_x_continuous(limits = c(3, 5.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
...
Valores_2 <- data.frame(
  ...
  annotate(geom = 'rect', xmin = 4.5, xmax = 5.0, ymin = 2.0, ymax = 2.5, colour = 'black', fill = 'black', alpha = 0.4) +
  annotate(geom = 'rect', xmin = 4.5, xmax = 5.0, ymin = 2.5, ymax = 3.0, colour = 'black', fill = 'black', alpha = 0.4) +
  annotate(geom = 'text', x = 4.0, y = 3.25, label = 'Valores', family = 'gochi', size = 8, colour = 'black') +
...
Dato_ordenado_1 <- data.frame(
  ...
  annotate(geom = 'text', x = 3.25, y = 5.25, label = 'Vec1', family = 'gochi', size = 6, colour = 'black') +
  annotate(geom = 'segment', x = 3.0, xend = 3.5, y = 5.0, yend = 5.0, colour = 'black') +
  annotate(geom = 'text', x = 4.0, y = 5.25, label = 'Vec2', family = 'gochi', size = 6, colour = 'black') +
  annotate(geom = 'segment', x = 3.75, xend = 4.25, y = 5.0, yend = 5.0, colour = 'black') +
  annotate(geom = 'text', x = 4.75, y = 5.25, label = 'Vec3', family = 'gochi', size = 6, colour = 'black') +
  annotate(geom = 'segment', x = 4.5, xend = 5.0, y = 5.0, yend = 5.0, colour = 'black') +
  annotate(geom = 'text', x = 5.5, y = 5.25, label = 'Vec4', family = 'gochi', size = 6, colour = 'black') +
  ...
  annotate(geom = 'text', x = 4.25, y = 6.5, label = 'data.frame', family = 'gochi', size = 8, colour = 'black') +
...
Dato_ordenado_2 <- data.frame(
  ...
  annotate(geom = 'text', x = 3.25, y = 5.25, label = 'País', family = 'gochi', size = 6, colour = 'black') +
  annotate(geom = 'segment', x = 3.0, xend = 3.5, y = 5.0, yend = 5.0, colour = 'black') +
  annotate(geom = 'text', x = 4.0, y = 5.25, label = 'Año', family = 'gochi', size = 6, colour = 'black') +
  annotate(geom = 'segment', x = 3.75, xend = 4.25, y = 5.0, yend = 5.0, colour = 'black') +
  annotate(geom = 'text', x = 4.75, y = 5.25, label = 'Casos', family = 'gochi', size = 6, colour = 'black') +
  annotate(geom = 'segment', x = 4.5, xend = 5.0, y = 5.0, yend = 5.0, colour = 'black') +
  annotate(geom = 'text', x = 5.5, y = 5.25, label = 'Pob.', family = 'gochi', size = 6, colour = 'black') +
  annotate(geom = 'segment', x = 5.25, xend = 5.75, y = 5.0, yend = 5.0, colour = 'black') +
  annotate(geom = 'segment', x = 3.0, xend = 3.5, y = 2.0, yend = 2.0, colour = 'black', linetype = 'dashed') +
  annotate(geom = 'segment', x = 3.0, xend = 3.5, y = 3.0, yend = 3.0, colour = 'black', linetype = 'dashed') +
  annotate(geom = 'segment', x = 3.0, xend = 3.5, y = 4.0, yend = 4.0, colour = 'black', linetype = 'dashed') +
  ...
  annotate(geom = 'segment', x = 5.5, xend = 5.5, y = 5.5, yend = 6.0, colour = 'black') +
  annotate(geom = 'segment', x = 3.25, xend = 5.5, y = 6.0, yend = 6.0, colour = 'black') +
  annotate(geom = 'text', x = 4.25, y = 6.5, label = 'Conjunto de datos 1', family = 'gochi', size = 8, colour = 'black') +
  scale_y_continuous(limits = c(1, 7.0)) +
  scale_x_continuous(limits = c(2.85, 6.0)) +
  theme_void() +
  theme(axis.text = element_blank(),
...
```{r, echo = FALSE, eval = FALSE, message = FALSE, fig.align = 'center', fig.showtext = TRUE, out.width = '520'}
...
```{r, echo = FALSE, eval = FALSE, message = FALSE, fig.align = 'center', fig.showtext = TRUE, out.width = '380'}
...
```{r, echo = FALSE, eval = FALSE, message = FALSE, fig.align = 'center', out.width = '440', fig.showtext = TRUE}
