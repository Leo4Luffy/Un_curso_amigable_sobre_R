...
La función `subset()` es una de las funciones de manejo de datos más útiles en `R`. Esta función permite extraer conjuntos de datos como se haría con el operador `[ ]` mediante los diferentes tipos de indexación ya vistos, pero el código es mucho más fácil de escribir.
...
data.frame(
  ...
  annotate(geom = 'text', x = 2.25, y = 3.75, label = 'Vector', family = 'gochi', size = 7.5, colour = 'black') +
  ...
  annotate(geom = 'text', x = 4.25, y = 3.75, label = 'Lista', family = 'gochi', size = 7.5, colour = 'black') +
  ...
  annotate(geom = 'text', x = 2.25, y = 2.25, label = 'Matriz', family = 'gochi', size = 7.5, colour = 'black') +
  ...
  annotate(geom = 'text', x = 4.25, y = 2.25, label = 'Conjunto de datos', family = 'gochi', size = 7.5, colour = 'black') +
  ...
  annotate(geom = 'text', x = 2.25, y = -0.25, label = 'Arreglo', family = 'gochi', size = 7.5, colour = 'black') +
