...
data.frame(
  ...
  annotate(geom = 'text', x = 2.6, y = 4.65, label = 'Tu nombre de carpeta del proyecto', family = 'gochi', size = 10.4, colour = 'black') +
  annotate(geom = 'rect', xmin = 1.33, xmax = 1.38, ymin = 1.2, ymax = 4.3, colour = 'black', fill = 'black', alpha = 0.4) +
  annotation_custom(rstudio_imagen, xmin = 1.8, xmax = 2.5, ymin = 3.5, ymax = 4.2)
  #scale_x_continuous(limits = c(2, 4.6)) +
  #theme_void() +
  #theme(axis.text = element_blank(),
   #     axis.ticks = element_blank(),
