...
>>>>>>> 50c958d8f55a56388e5bd0ab733529c29b2c0629
...
organizar <- data.frame(
  ...
  geom_curve(x = 19.6, xend = 19.6, y = 4.5, yend = 9.5, arrow = arrow(length = unit(0.1, 'inch')), size = 1.4, color = 'black', curvature = 0.0) +
  geom_curve(x = 25.6, xend = 25.6, y = 9.5, yend = 4.5, arrow = arrow(length = unit(0.1, 'inch')), size = 1.4, color = 'black', curvature = 0.0) +
...
=======
  annotate(geom = 'text', x = 14.7, y = 11.5, label = '.data = palmerpenguins,', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 13.78, y = 11.25, label = '-culmen_depth,', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 13.54, y = 11.0, label = 'body_mass', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 12.25, y = 10.75, label = ')', size = 7.4, colour = 'black') +
>>>>>>> 50c958d8f55a56388e5bd0ab733529c29b2c0629
  scale_y_continuous(limits = c(4.0, 11.78)) +
  #scale_x_continuous(limits = c(8, 5.0)) +
  theme_void() +
...
renombre <- data.frame(
  ...
  annotate(geom = 'text', x = 14.8, y = 11.5, label = '.data = palmerpenguins,', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 13.7, y = 11.25, label = 'gender = sex', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 12.2, y = 11.0, label = ')', size = 7.4, colour = 'black') +
