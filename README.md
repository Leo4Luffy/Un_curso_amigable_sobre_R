# Un curso amigable sobre R <img src="https://github.com/Leo4Luffy/Un_curso_amigable_sobre_R/blob/master/images/imagen_curso.png" align="right" width="220" height="240" />

Este es un repositorio para preparar un curso sobre el lenguaje de programación _R_. Este se basa principalmente en mostrar las funcionalidades del conjunto de paquetes del _tidyverse_. <!--Puedes disfrutar de él dandole clic <a href="https://jorge-leonardo-lopez-martinez.shinyapps.io/Curso_R_amigable/">aquí</a>.-->
